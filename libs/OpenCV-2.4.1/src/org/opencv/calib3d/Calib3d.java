 ...
 * three Euler angles (as the return value) that could be used in OpenGL.</p>
 *
 ...
 * Euler angles that could be used in OpenGL.</p>
 *
 ...
 * returned coordinates are not accurate enough.</p>
 *
